...
public class TextArchitect2
{
	...
	public TextArchitect2(TextMeshProUGUI tmpro, string targetText, string preText = "", int charactersPerFrame = 1, float speed = 1f)
	{
		this.tmpro = tmpro;
	...
	void Initiate()
	{
		...
		TextArchitect2 existingArchitect = null;
